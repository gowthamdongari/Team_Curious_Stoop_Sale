...
export function ImageMapCard() {
  ...
  return (
    <Card className="w-full max-w-[50rem] shadow-lg flex flex-col lg:flex-row rounded-lg overflow-hidden">
      <div className="w-full lg:w-1/2">
        <CardHeader floated={false} color="blue-gray" className="h-64 lg:h-full p-0">
          <img
